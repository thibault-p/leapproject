    ...
    public class MagicContentManager : Manager
    {
        ...
        public void Initialize()
        {
            ...
            var textures = (
                ...
                select new Texture2DContentItem()
                {
                    ...
                    IsEmptyTexture = text.IsEmptyTexture
        ...
        public Texture2D EmptyTexture
        {
            get
            {
                ...
                {
                    throw new ArgumentException("EmptyTexture not defined!");
                }
        ...
        public SpriteFont Font
        {
            get
            {
                ...
                {
                    throw new ArgumentException("Default Font not defined!");
                }
